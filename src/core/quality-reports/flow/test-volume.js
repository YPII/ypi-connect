...
function dataHandler (req, res, callback) {
  ...
  var sql = 'call rpt_flow_volume_summary(?)'
...
module.exports = {
  register: function (routeMap) {
    routeMap['/quality-reports/flow/test-volume'] = routeHandler
    routeMap['/quality-reports/flow/test-volume/data'] = dataHandler
    routeMap['/quality-reports/flow/test-volume/chart'] = chartHandler
  }
}
